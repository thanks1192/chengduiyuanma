<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"/www/wwwroot/28.zheyj.com/public/../application/admin/view/sell/add.html";i:1610985799;s:68:"/www/wwwroot/28.zheyj.com/application/admin/view/layout/default.html";i:1602168706;s:65:"/www/wwwroot/28.zheyj.com/application/admin/view/common/meta.html";i:1602168706;s:67:"/www/wwwroot/28.zheyj.com/application/admin/view/common/script.html";i:1602168706;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-bank_account" data-rule="required" class="form-control" name="row[bank_account]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Bank_card'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-bank_card" data-rule="required" class="form-control" name="row[bank_card]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Bank_branch'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-bank_branch" data-rule="required" class="form-control" name="row[bank_branch]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Ip'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-ip" data-rule="required" class="form-control" name="row[ip]" type="text" value="">
        </div>
    </div>
